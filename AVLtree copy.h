...
namespace AVL{
    ...
    class AVLTree{
        private:
            ...
            enum ScanFlag{
                PRE_ORDER_OUTPUT, IN_ORDER_OUTPUT,
                IN_ORDER_OUTPUT_BACKWARDS, IN_ORDER_INPUT_BACKWARDS
            }
        public:
            ...
            friend void AVLMerge(AVLTree& root1, AVLTree& root2);
    ...
    */
    ...
    template<class KeyElem, class Data>
    void AVLMerge(AVLTree<KeyElem,Data>& tree1, AVLTree<KeyElem,Data>& tree2){
        //allocating two arrays for merging
        TNode** tree1_arr = new TNode*[tree1.size];
        TNode** tree2_arr = new TNode*[tree2.size];
        TNode** merged_arr = new TNode*[tree1.size + tree2.size];
        AVLTree<KeyElem,Data> merged_tree;

        tree1.AVLScan(tree1_arr, tree1.root, AVLTree<KeyElem,Data>::IN_ORDER_OUTPUT);
        tree2.AVLScan(tree2_arr, tree2.root, AVLTree<KeyElem,Data>::IN_ORDER_OUTPUT);
        
        tree2.AVLInOrderScan(tree2_arr, tree2.root);
        arrayMerge(merged_arr, tree1_arr, tree2_arr);
    ...
    template<class KeyElem, class Data>
    void AVLTree<KeyElem,Data>::AVLScan(AVLTree<KeyElem,Data>::TNode** array, AVLTree<KeyElem,Data>::TNode* node, ScanFlag flag){
        
    }

    template<class KeyElem, class Data>
    void AVLTree<KeyElem,Data>::AVLArrayToTree(AVLTree<KeyElem,Data>::TNode** array, AVLTree<KeyElem,Data>::TNode* node, int size){
        if(33)

    }

    template<class KeyElem, class Data>
    void AVLTree<KeyElem,Data>::AVLInOrderScanInBackwards(){
